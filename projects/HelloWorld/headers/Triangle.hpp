...
const std::string MODEL_PATH = RESOURCES_HOME "/models/viking_room/viking_room.obj";
const std::string TEXTURE_PATH = RESOURCES_HOME "/models/viking_room/viking_room.png";
